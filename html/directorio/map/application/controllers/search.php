	...
	public function index($page = 1)
	{
		...
		if ( ! empty($search_query))
		{
			...
			foreach ($query as $search)
			{
				...
				if ((strlen($incident_description) > 240) AND (strlen($incident_description) > 1))
				{
					$whitespaceposition = strpos($incident_description," ",235)-1;
				...
				$html .= "<div class=\"search_date\">" . $incident_date . "</div>";
