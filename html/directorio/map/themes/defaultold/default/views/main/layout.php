...
<div id="main" class="clearingfix">
	...
	<?php endif; ?>
		...
		<div id="right" class="clearingfix">
			...
			<!-- additional content -->
<div id="descripcionplat" style="width:275px;font-size:10pt;font-family:Arial, Helvetica, sans-serif;background-color:#C0C0C0;padding:10px">Aqu&iacute; puedes ver las colaboraciones de las personas que participaron en los encuentros realizados por la Corporaci&oacute;n Somos M&aacute;s, en 10 regionales del ICBF, para el fortalecimiento de las familias y comunidades</div>
